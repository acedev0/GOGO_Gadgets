...
func TestGG_Main(t *testing.T) {
	
	C.Println("GOGO Main test")
}
...
/* 
Usage: GET_FUNC_PARAM(paramINDEX, "", true|false, params... )     (note ellipses AFTER params)
...
func MASTER_INIT(PROGNAME string, ALL_PARAMS ...float64) {
	...
	SHOW_BOX_MESSAGE(PROGNAME, "|yellow|Running On: " + CURRENT_OS + "," + GOOS_VALUE)
